 ...
 * OSS2
 *
 * This file is based on the "OSS Framework" - a library of tools, utilities and
...
class Array
{
    ...
    /**
     * Filters out key-value pairs from arrays (typically from Doctrine result sets).
     * Both the $key and $value parameters are array keys in the $array.
     *
     * @param array   $array The input array
     * @param string  $key   Array element to become the key
     * @param string  $value Array element to become the value
     * @param boolean $unique Return with unique values only
     * @return array
     */
    public static function filterKeyValuePairs( $array, $key, $value, $unique = false)
    {
        $a = [];
        ...
        return( $unique == true ? array_unique( $a ) : $a );
    }
